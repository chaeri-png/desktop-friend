...
export function createModel(container) {
  ...
  function frame() {
    ...
    else if (anim === 'cheer') { bobAmp = 0.08; bobSpeed = 6.5; spin = 3.6; earWiggle = 0.2; }
  ...
  const accessories = initAccessories(pet, {
    ...
    // 찐빵 몸(아래·볼이 넉넉)에 맞춘 옷 밴드
    body: { cy: -0.25, rx: 1.42, ry: 1.3, rz: 1.4, shirtTheta: [1.25, 0.85], pantsTheta: [2.05, 0.58], patchY: -0.25, patchZ: 1.58 },
  });
